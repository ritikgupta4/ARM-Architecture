//Full descending stack->pointer at array-length-1 (first element position). Pointer stays at location of last added data. Initially element present arr[length-1] to show how it works
...
void print(struct Stack* stack)
{
    ...
    for(int i=stack->size-1;i>=stack->sp;i--)
    {
        printf("%d\n",stack->arr[i]);
    }
}