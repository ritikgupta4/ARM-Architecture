//Empty descending stack-> pointer at array length - 2 (considering data at arr[length-1]) as pointer points at the free location
...
void print(struct Stack* stack)
{
    ...
    for(int i=stack->size-1;i>=stack->sp+1;i--)
    {
        printf("%d\n",stack->arr[i]);
    }
}